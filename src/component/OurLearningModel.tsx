...
const IconTool = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M8.5 8.5a2.5 2.5 0 0 0 0 3.5" />
    <path d="M5.5 11.5a5.5 5.5 0 0 0 7 0" />
  </svg>
);
const IconComm = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M17 6.5a4 4 0 0 0-8 0c0 .7.2 1.3.5 1.9L5 13a4 4 0 1 0 3.5 6.5l4.6-4.5A4.05 4.05 0 0 0 17 14.5a4 4 0 1 0 0-8Z" />
  </svg>
);
const IconSearch = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <Row gutter={[36, 32]} align="middle">
        <Col xs={24} lg={12}>
          <div style={{ color: colors.orangePrimary }} className="text-sm sm:text-base leading-relaxed ml-25">
            ...
            <p>
              At Dev Plus, we aim to transform learners’ mindset, skillset, and toolset through mentoring, hackathons, on-the-job training, and fast-track programs. We work
              closely with schools, government bodies, industry experts, and companies to deliver work-integrated learning experiences that ensures learners develop practical
              skills, professional readiness, and adaptability, so they truly get ready to work.
            </p>
          </div>
        </Col>
          ...
          <div className="group relative w-full max-w-[320px] sm:max-w-[420px] md:max-w-[520px] lg:max-w-[600px] aspect-square mx-auto flex items-center justify-center mt-10 lg:mt-0 cursor-pointer">
            <div className="relative w-full h-full flex items-center justify-center transition-all duration-500 ease-in-out group-hover:scale-[1.03] group-hover:drop-shadow-2xl">
              <div
                ...
                className="absolute w-[90%] h-[90%] rounded-full border-[8px] opacity-90 z-0 pointer-events-none transition-all duration-500 group-hover:border-opacity-100"
              ></div>
              <div
                style={{ borderColor: colors.orangePrimary, backgroundColor: "white" }}
                className="absolute w-[68%] h-[68%] rounded-full border-[4px] z-10 shadow-sm pointer-events-none"
              ></div>
                ...
                >
                  ...
                  >
                    <div className="relative w-[100px] mb-[2px] flex-shrink-0">
                      ...
                      <div
                        style={{ backgroundColor: colors.orangePrimary, clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)" }}
